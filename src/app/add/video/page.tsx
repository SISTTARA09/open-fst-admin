import { uploadVideo } from "@/app/utils/add/add-video";
/// imports
...
const AddSingleVideo = () => {
	return (
		<>
			...
			<form className="form" action={uploadVideo}>
				...
				{/* start path */}
				<div className="field-container">
					<label htmlFor="path">video path</label>
					<input
						type="text"
						name="path"
						id="path"
						placeholder="youtube video <_"
					/>
					<p className="error path"></p>
				</div>
				{/* end path */}
